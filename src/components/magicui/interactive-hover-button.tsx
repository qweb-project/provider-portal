  ...
  return (
    <div className="group/button">
      <button
        ref={ref}
        className={cn(
          "relative w-auto cursor-pointer overflow-hidden rounded-full border bg-background p-2 px-6 text-center font-semibold",
          className,
        )}
        {...props}
      >
        <div className="flex items-center gap-2">
          <div className="h-4 w-4 rounded-full bg-primary transition-all duration-300 group-hover/button:scale-[100.8]"></div>
