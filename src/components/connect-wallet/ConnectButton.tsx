      ...
      {isOpen && (
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={() => setIsOpen(false)}>
            <div className="w-full max-w-sm rounded-xl border border-border min-h-[40vh] bg-background p-6 shadow-xl flex flex-col items-center" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="space-y-4 w-full text-center">
                  ...
                  <div className="flex gap-2 justify-center">
                    <div className="flex gap-2">
                      ...
                      <Button size="sm" radius="xl" onClick={handleVerify} disabled={!canVerify}>
                        Verify
                      </Button>
                    </div>
                  </div>
              ...
              <div className="mt-6 w-full border-t border-border pt-3 text-center text-xs text-muted-foreground">
